...
\begin{document}
	...
	\centerline{%
		...
		\begin{minipage}{0.5\textwidth}
			...
			\flushright\normalfont\footnotesize Revised the \nth{27} of April, 2017 \enspace\enspace
		\end{minipage}
	}
	...
	\vspace{.2in}
	\par\noindent\makebox[2.5in]{\includegraphics[height=2.5cm]{dellinger}} \hfill\makebox[2.0in]{4/27/2017}
	\vspace{-.15in}
