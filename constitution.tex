...
\newcommand*{\MaxNumOfConstitutionArticles}{10}
\newcommand*{\MaxNumOfByLawArticles}{04}
...
\begin{document}
	...
	\foreach \a in {00, 01, 02, 03, 04, 05, 06, 07, 08, 09, 10, ...,\MaxNumOfConstitutionArticles}{
		\IfFileExists{Article_\a} {
			\input{Article_\a}
		}{
	...
	\foreach \a in {00, 01, 02, 03, 04, 05, 06, 07, 08, 09, 10, ...,\MaxNumOfByLawArticles}{
		\IfFileExists{By-Laws/Article_\a} {
			\input{By-Laws/Article_\a}
		}{
			% files does not exist, so nothing to do
		}
	}
